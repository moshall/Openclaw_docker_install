...
assert_contains "${upgrade_output}" "docker cp openclaw_demo:/root/.pip/. /opt/1panel/apps/openclaw_demo/runtime/root-pip-config/"
assert_contains "${upgrade_output}" "docker cp openclaw_demo:/root/.cargo/config /opt/1panel/apps/openclaw_demo/runtime/root-cargo-config"
assert_contains "${upgrade_output}" "docker cp openclaw_demo:/root/.cargo/config.toml /opt/1panel/apps/openclaw_demo/runtime/root-cargo-config-toml"
...
assert_contains "${upgrade_output}" "/runtime/root-pip-config:/root/.pip"
assert_contains "${upgrade_output}" "/runtime/root-cargo-config:/root/.cargo/config"
assert_contains "${upgrade_output}" "/runtime/root-cargo-config-toml:/root/.cargo/config.toml"
